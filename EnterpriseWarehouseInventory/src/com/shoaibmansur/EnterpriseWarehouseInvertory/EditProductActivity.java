...
public class EditProductActivity extends Activity {
	...
	private static final String TAG_PRICE = "location";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Item_ID = i.getStringExtra(TAG_PID);
	...
	class GetProductDetails extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pDialog.setMessage("Loading equipment details. Please wait...");
					...
					try {
						...
						if (success == 1) {
							...
							JSONArray productObj = json
									.getJSONArray(TAG_EQUIPMENT); // JSON Array
	...
	class SaveProductDetails extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(EditProductActivity.this);
			pDialog.setMessage("Saving equipment ...");
			pDialog.setIndeterminate(false);
			pDialog.setCancelable(true);
			pDialog.show();
		}
		...
		protected String doInBackground(String... args) {
			...
			String Item_Name = txtName.getText().toString();
			String location = txtPrice.getText().toString();
			String description = txtDesc.getText().toString();

			// Building Parameters
			List<NameValuePair> params = new ArrayList<NameValuePair>();
			params.add(new BasicNameValuePair(TAG_PID, Item_ID));
			params.add(new BasicNameValuePair(TAG_NAME, Item_Name));
			params.add(new BasicNameValuePair(TAG_PRICE, location));
	...
	class DeleteProduct extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(EditProductActivity.this);
			pDialog.setMessage("Deleting Equipment...");
			pDialog.setIndeterminate(false);
			pDialog.setCancelable(true);
			pDialog.show();
		}
		...
		protected String doInBackground(String... args) {
			...
			try {
				// Building Parameters
				List<NameValuePair> params = new ArrayList<NameValuePair>();
				params.add(new BasicNameValuePair("pid", Item_ID));
